...
ReviewsRatingGoogleModel reviewsRatingGoogleModelFromJson(String str) =>
    ReviewsRatingGoogleModel.fromJson(json.decode(str));

String reviewsRatingGoogleModelToJson(ReviewsRatingGoogleModel data) =>
    json.encode(data.toJson());

class ReviewsRatingGoogleModel {
  ReviewsRatingGoogleModel({
  ...
  factory ReviewsRatingGoogleModel.fromJson(Map<String, dynamic> json) =>
      ReviewsRatingGoogleModel(
        ...
        result: json["result"] == null
            ? null
            : Resultrating.fromJson(json["result"]),
...
class Resultrating {
  ...
  factory Resultrating.fromJson(Map<String, dynamic> json) => Resultrating(
